...
public class Created
	...
	//		System.out.println("Number of messages : " + sd.countNbMessages());
	//		final IntVar variable1 =
	//			problem.makeBoundIntVar("v1", 0, sd.countNbMessages());
	//		final IntVar variable2 =
	//			problem.makeBoundIntVar("v2", 0, sd.countNbClassifiers());
	//		final Constraint constraint = new Created(variable1, variable2, sd);
	//
