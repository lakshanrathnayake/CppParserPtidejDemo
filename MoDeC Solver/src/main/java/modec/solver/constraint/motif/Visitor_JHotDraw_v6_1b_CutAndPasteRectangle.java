 ...
 * @author Janice Ng
 */
public class Visitor_JHotDraw_v6_1b_CutAndPasteRectangle {
	...
	public static void main(final String[] args) {
		...
		final ExecutionTraceParser etp =
				//new ExecutionTraceParser("../MoDeC Bytecode Instrumentation Tests/JHotDraw_Visitor_CASCONResults.trace");
				//	new ExecutionTraceParser("../MoDeC Bytecode Instrumentation Tests/Evaluation_JHotDraw_Visitor_CutAndPasteRectangle.trace");
				//new ExecutionTraceParser("../MoDeC Bytecode Instrumentation Tests/JHotDraw_EVALUATION_CutPasteGOOD.trace");
				//new ExecutionTraceParser("../MoDeC Bytecode Instrumentation Tests/Visitor_GOF_EVALUATION.trace");
				...
				new ExecutionTraceParser(
						"../MoDeC Bytecode Instrumentation Tests/Visitor_OrderManager_EVALUATION.trace");
		...
		concreteElementType.add(
				"org.jhotdraw.contrib.html.RoundRectangleFigureGeometricAdapter");
		...
		subclasses.put("org.jhotdraw.framework.FigureVisitor",
				concreteVisitorType);
		...
		// VISITOR 1 
		final IntVar v_anObjStruct1 = problem
				.makeBoundIntVar("anObjectStructure1", 0, nbClassifiers);

		final IntVar v_aConcreteElement1 = problem
				.makeBoundIntVar("aConcreteElement1", 0, nbClassifiers);

		final IntVar v_accept1 = problem.makeBoundIntVar("accept1", 0,
				nbMessages);

		final IntVar v_visitConcreteElement1 = problem
				.makeBoundIntVar("visitConcreteElement1", 0, nbMessages);

		final IntVar v_operation1 = problem.makeBoundIntVar("operation1", 0,
				nbMessages);

		final IntVar v_aConcreteVisitor1 = problem
				.makeBoundIntVar("aConcreteVisitor1", 0, nbClassifiers);

		final IntVar v_operation1Caller = problem
				.makeBoundIntVar("operation1Caller", 0, nbClassifiers);

		problem.post(
				new PalmNotEqualXYC(v_anObjStruct1, v_aConcreteElement1, 0));
		problem.post(
				new PalmNotEqualXYC(v_anObjStruct1, v_aConcreteVisitor1, 0));
		problem.post(new PalmNotEqualXYC(v_aConcreteVisitor1,
				v_aConcreteElement1, 0));
		problem.post(new PalmNotEqualXYC(v_aConcreteElement1,
				v_operation1Caller, 0));

		problem.post(new MessageFollows(v_accept1, v_visitConcreteElement1, sd,
				componentsMessages));
		problem.post(new MessageFollows(v_visitConcreteElement1, v_operation1,
				sd, componentsMessages));
		problem.post(new MessageFollows(v_accept1, v_operation1, sd,
				componentsMessages));
		problem.post(new Caller(v_anObjStruct1, v_accept1, sd,
				componentsMessages, allClassifiers));
		problem.post(new Callee(v_accept1, v_aConcreteElement1, sd,
				componentsMessages, allClassifiers));
		problem.post(new Caller(v_aConcreteElement1, v_visitConcreteElement1,
				sd, componentsMessages, allClassifiers));
		problem.post(new Callee(v_visitConcreteElement1, v_aConcreteVisitor1,
				sd, componentsMessages, allClassifiers));
		problem.post(new Caller(v_operation1Caller, v_operation1, sd,
				componentsMessages, allClassifiers));
		problem.post(new Callee(v_operation1, v_aConcreteElement1, sd,
				componentsMessages, allClassifiers));

		problem.post(new ParameterCalleeSameType(v_accept1,
				v_visitConcreteElement1, sd, componentsMessages, subclasses));

		problem.post(new ParameterCalleeSameType(v_visitConcreteElement1,
				v_accept1, sd, componentsMessages, subclasses));

		problem.post(new IsContainedInMessage(v_operation1,
				v_visitConcreteElement1, sd, componentsMessages));

		// VISITOR 2
		final IntVar v_anObjStruct2 = problem
				.makeBoundIntVar("anObjectStructure2", 0, nbClassifiers);

		final IntVar v_aConcreteElement2 = problem
				.makeBoundIntVar("aConcreteElement2", 0, nbClassifiers);

		final IntVar v_accept2 = problem.makeBoundIntVar("accept2", 0,
				nbMessages);

		final IntVar v_visitConcreteElement2 = problem
				.makeBoundIntVar("visitConcreteElement2", 0, nbMessages);

		final IntVar v_operation2 = problem.makeBoundIntVar("operation2", 0,
				nbMessages);

		final IntVar v_aConcreteVisitor2 = problem
				.makeBoundIntVar("aConcreteVisitor2", 0, nbClassifiers);

		final IntVar v_operation2Caller = problem
				.makeBoundIntVar("operation2Caller", 0, nbClassifiers);

		problem.post(
				new PalmNotEqualXYC(v_anObjStruct2, v_aConcreteElement2, 0));
		problem.post(
				new PalmNotEqualXYC(v_anObjStruct2, v_aConcreteVisitor2, 0));
		problem.post(new PalmNotEqualXYC(v_aConcreteVisitor2,
				v_aConcreteElement2, 0));
		problem.post(new PalmNotEqualXYC(v_aConcreteElement2,
				v_operation2Caller, 0));

		problem.post(new MessageFollows(v_accept2, v_visitConcreteElement2, sd,
				componentsMessages));
		problem.post(new MessageFollows(v_visitConcreteElement2, v_operation2,
				sd, componentsMessages));
		problem.post(new MessageFollows(v_accept2, v_operation2, sd,
				componentsMessages));
		problem.post(new Caller(v_anObjStruct2, v_accept2, sd,
				componentsMessages, allClassifiers));
		problem.post(new Callee(v_accept2, v_aConcreteElement2, sd,
				componentsMessages, allClassifiers));
		problem.post(new Caller(v_aConcreteElement2, v_visitConcreteElement2,
				sd, componentsMessages, allClassifiers));
		problem.post(new Callee(v_visitConcreteElement2, v_aConcreteVisitor2,
				sd, componentsMessages, allClassifiers));
		//		problem.post(
		//			new Caller(
		//				v_aConcreteVisitor2,
		...
		//				componentsMessages,
		//				allClassifiers));
		problem.post(new Caller(v_operation2Caller, v_operation2, sd,
				componentsMessages, allClassifiers));
		problem.post(new Callee(v_operation2, v_aConcreteElement2, sd,
				componentsMessages, allClassifiers));

		problem.post(new ParameterCalleeSameType(v_accept2,
				v_visitConcreteElement2, sd, componentsMessages, subclasses));

		problem.post(new ParameterCalleeSameType(v_visitConcreteElement2,
				v_accept2, sd, componentsMessages, subclasses));

		problem.post(new IsContainedInMessage(v_operation2,
				v_visitConcreteElement2, sd, componentsMessages));

		// CHECK
		problem.post(new PalmNotEqualXYC(v_operation1, v_operation2, 0));
		problem.post(new PalmNotEqualXYC(v_aConcreteVisitor1,
				v_aConcreteVisitor2, 0));
		...
		//				componentsMessages,
		//				allClassifiers));
		problem.post(new SameType(v_aConcreteElement1, v_aConcreteElement2, sd,
				componentsMessages, allClassifiers));

		problem.post(new SameType(v_operation1Caller, v_operation2Caller, sd,
				componentsMessages, allClassifiers));
				...
				if (record.getMessage().equals("A solution was found.")) {
					try {
						final Writer fstream = ProxyDisk.getInstance()
								.fileAbsoluteOutput(
										"../MoDeC Bytecode Instrumentation Tests/Solution_JHotDraw_Visitor_CutAndPasteRectangle.txt",
										true);
