 ...
 * @author Janice Ng
 */
public class Command_QuickUML_v2001_DeactivateToggleRefreshButton {
					...
					try {
						final Writer fstream =
							ProxyDisk
								.getInstance()
								.fileAbsoluteOutput(
									"../MoDeC Bytecode Instrumentation Tests/Solution_QuickUML_Command_ToggleRefreshADiagram.txt",
									true);
