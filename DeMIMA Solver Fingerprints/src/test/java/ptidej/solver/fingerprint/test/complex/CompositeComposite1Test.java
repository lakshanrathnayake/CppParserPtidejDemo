...
public class CompositeComposite1Test extends TestCase {
	...
	public CompositeComposite1Test(final String name) {
		super(name);
	}
	...
	protected void setUp()
		...
		if (CompositeComposite1Test.FoundSolutions == null) {
			...
			// Expected solutions.
			CompositeComposite1Test.ExpectedSolutions = SolutionReader
					.getExpectedSolutions("Composite1", codeLevelModel);
			CompositeComposite1Test.NumberOfExpectedSolutions = SolutionReader
			...
			final OccurrenceBuilder solutionBuilder = OccurrenceBuilder
					.getInstance();
			CompositeComposite1Test.FoundSolutions = solutionBuilder
	...
	public void testNumberOfSolutions() {
		Assert.assertEquals("Number of solutions",
				CompositeComposite1Test.NumberOfExpectedSolutions,
				CompositeComposite1Test.FoundSolutions.length);
	}

	public void testSolutions() {
		for (int i = 0; i < CompositeComposite1Test.NumberOfExpectedSolutions; i++) {
			Assert.assertEquals("", CompositeComposite1Test.ExpectedSolutions[i],
					CompositeComposite1Test.FoundSolutions[i]);
		}
	}
