...
//		});
		...
		if ((optionPane.getValue() != null) && (optionPane.getValue().equals(Integer.valueOf(JOptionPane.OK_OPTION)))) {
	...
	private Drawing showRestoreDialog(DrawingListModel listModel) {
		...
		if ((optionPane.getValue() != null)
				&& (optionPane.getValue().equals(Integer.valueOf(JOptionPane.OK_OPTION)))
