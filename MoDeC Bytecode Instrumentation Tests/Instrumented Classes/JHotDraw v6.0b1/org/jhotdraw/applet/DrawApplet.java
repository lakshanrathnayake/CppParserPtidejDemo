...
public class DrawApplet
	...
	protected void createAttributeChoices(JPanel panel) {
		...
		choice.addItem(new ChangeAttributeCommand("none",     arrowMode, Integer.valueOf(PolyLineFigure.ARROW_TIP_NONE),  this));
		choice.addItem(new ChangeAttributeCommand("at Start", arrowMode, Integer.valueOf(PolyLineFigure.ARROW_TIP_START), this));
		choice.addItem(new ChangeAttributeCommand("at End",   arrowMode, Integer.valueOf(PolyLineFigure.ARROW_TIP_END),   this));
		choice.addItem(new ChangeAttributeCommand("at Both",  arrowMode, Integer.valueOf(PolyLineFigure.ARROW_TIP_BOTH),  this));
