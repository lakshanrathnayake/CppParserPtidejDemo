...
public	class DrawApplication
	...
	protected JMenu createArrowMenu() {
		...
		menu.add(new UndoableCommand(
			new ChangeAttributeCommand("none", arrowMode, Integer.valueOf(PolyLineFigure.ARROW_TIP_NONE), this)));
		menu.add(new UndoableCommand(
			new ChangeAttributeCommand("at Start", arrowMode, Integer.valueOf(PolyLineFigure.ARROW_TIP_START), this)));
		menu.add(new UndoableCommand(
			new ChangeAttributeCommand("at End", arrowMode, Integer.valueOf(PolyLineFigure.ARROW_TIP_END), this)));
		menu.add(new UndoableCommand(
			new ChangeAttributeCommand("at Both", arrowMode, Integer.valueOf(PolyLineFigure.ARROW_TIP_BOTH), this)));
		return menu;
	}
	...
	protected JMenu createFontStyleMenu() {
		...
		menu.add(new UndoableCommand(
			new ChangeAttributeCommand("Plain", fontStyle, Integer.valueOf(Font.PLAIN), this)));
		menu.add(new UndoableCommand(
			new ChangeAttributeCommand("Italic", fontStyle, Integer.valueOf(Font.ITALIC), this)));
		menu.add(new UndoableCommand(
			new ChangeAttributeCommand("Bold", fontStyle, Integer.valueOf(Font.BOLD), this)));
		return menu;
	}
