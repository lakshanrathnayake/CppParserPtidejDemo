...
public abstract class AttributeFigure extends AbstractFigure {
	...
	private static void initializeAttributes() {
		...
		fgDefaultAttributes.set(FigureAttributeConstant.ARROW_MODE,  Integer.valueOf(0));
		fgDefaultAttributes.set(FigureAttributeConstant.FONT_NAME,  "Helvetica");
		fgDefaultAttributes.set(FigureAttributeConstant.FONT_SIZE,   Integer.valueOf(12));
		fgDefaultAttributes.set(FigureAttributeConstant.FONT_STYLE,  Integer.valueOf(Font.PLAIN));
	}
