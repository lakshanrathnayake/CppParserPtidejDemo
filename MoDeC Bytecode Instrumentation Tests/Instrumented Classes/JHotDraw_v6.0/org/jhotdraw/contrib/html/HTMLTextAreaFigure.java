...
public class HTMLTextAreaFigure extends TextAreaFigure
	...
	static {
		initDefaultAttribute("XAlignment", Integer.valueOf(SwingConstants.LEFT));
		initDefaultAttribute("YAlignment", Integer.valueOf(SwingConstants.TOP));
		initDefaultAttribute("LeftMargin", Float.valueOf(5));
		initDefaultAttribute("RightMargin", Float.valueOf(5));
		initDefaultAttribute("TopMargin", Float.valueOf(5));
		initDefaultAttribute("BottomMargin", Float.valueOf(5));
		initDefaultAttribute("TabSize", Float.valueOf(8));
	}
