	...
	public void test() {
		try {
			Caffeine
				.getUniqueInstance()
				.start(
				// "../Caffeine Tests/src/caffeine/test/composition9/Test.trace",
					"../Caffeine/Rules/Composition.pl",
					"../Caffeine/cfparse.jar;../Caffeine/javassist.jar;../Caffeine/bin;../Caffeine Tests/bin",
					"caffeine.test.composition9.Composition",
					new String[] { "caffeine.test.composition9.*" },
					Constants.GENERATE_FINALIZER_ENTRY_EVENT
							| Constants.GENERATE_PROGRAM_END_EVENT,
					new String[][] { new String[] {
							"caffeine.test.composition9.A",
							"caffeine.test.composition9.B", "b" } });
		}
