	...
	public void test() {
		try {
			Caffeine
				.getUniqueInstance()
				.start(
				// "../Caffeine Tests/src/caffeine/test/composition4/NEW Test.trace",
					"../Caffeine/Rules/Composition.pl",
					"../Caffeine/cfparse.jar;../Caffeine/javassist.jar;../Caffeine/bin;../Caffeine Tests/bin",
					"caffeine.test.composition4.Composition",
					new String[] { "caffeine.test.composition4.*" },
					Constants.GENERATE_FINALIZER_ENTRY_EVENT
							| Constants.GENERATE_PROGRAM_END_EVENT,
					new String[][] { new String[] {
							"caffeine.test.composition4.A",
							"caffeine.test.composition4.B", "b" } });
		}
