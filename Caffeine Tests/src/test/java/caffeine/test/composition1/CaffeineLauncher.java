 ...
 * All Rights Reserved.
 */
package caffeine.test.composition1;
	...
	public void test() {
		try {
			Caffeine
				.getUniqueInstance()
				.start(
				// "../Caffeine Tests/src/caffeine/test/composition1/Test.trace",
					"../Caffeine/Rules/Composition.pl",
					"../Caffeine/cfparse.jar;../Caffeine/javassist.jar;../Caffeine/bin;../Caffeine Tests/bin",
					"caffeine.test.composition1.Composition",
					new String[] { "caffeine.test.composition1.*" },
					Constants.GENERATE_FINALIZER_ENTRY_EVENT
							| Constants.GENERATE_PROGRAM_END_EVENT,
					new String[][] { new String[] {
							"caffeine.test.composition1.A",
							"caffeine.test.composition1.B", "b" } });
		}
