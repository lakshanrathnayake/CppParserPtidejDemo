	...
	public void test() {
		try {
			Caffeine
				.getUniqueInstance()
				.start(
				// "../Caffeine Tests/src/caffeine/test/composition7/counterexample/Test.trace",
					"../Caffeine/Rules/Composition.pl",
					"../Caffeine/cfparse.jar;../Caffeine/javassist.jar;../Caffeine/bin;../Caffeine Tests/bin",
					"caffeine.test.composition7.counterexample.Composition",
					new String[] { "caffeine.test.composition7.counterexample.*" },
					Constants.GENERATE_FINALIZER_ENTRY_EVENT
							| Constants.GENERATE_PROGRAM_END_EVENT,
					new String[][] { new String[] {
							"caffeine.test.composition7.counterexample.A",
							"caffeine.test.composition7.counterexample.B", "b" } });
		}
