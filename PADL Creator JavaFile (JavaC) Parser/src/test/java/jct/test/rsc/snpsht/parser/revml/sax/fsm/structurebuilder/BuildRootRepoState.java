...
public class BuildRootRepoState extends AbstractRevMLState {
	...
	public void endElement(String uri, String localName, String name)
			throws SAXException {
		if (jct.test.rsc.snpsht.parser.revml.RevMLDocCommonsStrings.ROOT_REPOSITORY_MARKER.compareTo(name
			.trim()
			.toLowerCase()) == 0) {
				...
				.changeState(
					new ErrorStateRevMLState(
						...
						"Misformed xml document.\nEnd marker unexpected.\nReceived: "
								+ name
								+ "\nExpected: "
								+ jct.test.rsc.snpsht.parser.revml.RevMLDocCommonsStrings.ROOT_REPOSITORY_MARKER,
